...
void SetupAndRunMissingColumnSimulation(unsigned randomSeed, bool, bool, bool, unsigned,
...
int main(int argc, char *argv[]) {
	...
	SetupAndRunMissingColumnSimulation(random_seed, random_birth_times, random_division_directions,
			cartesian_grid,
...
void SetupAndRunMissingColumnSimulation(unsigned random_seed,
	...
	// setup the missing column and the fixed division direction
...
//	std::cout << sheet_params_file.is_open() << std::endl;
	...
	sheet_params_file << "---------------------------------\n";
    sheet_params_file << "Missing column experiment.\n";
