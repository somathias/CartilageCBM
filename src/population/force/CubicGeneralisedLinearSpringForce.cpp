/*
 * CubicGeneralisedLinearSpringForce.cpp
 *
...
CubicGeneralisedLinearSpringForce<ELEMENT_DIM, SPACE_DIM>::CubicGeneralisedLinearSpringForce() :
		GeneralisedLinearSpringForce<ELEMENT_DIM, SPACE_DIM>() {
}


template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
c_vector<double, SPACE_DIM> CubicGeneralisedLinearSpringForce<
	...
	if (bool(
			dynamic_cast<MeshBasedCellPopulation<ELEMENT_DIM, SPACE_DIM>*>(&rCellPopulation))) {
		return multiplication_factor * spring_stiffness
		...
		c_vector<double, SPACE_DIM> temp = multiplication_factor
					...
					* (distance_between_nodes - cut_off_length)
                    * (distance_between_nodes - cut_off_length);
		return temp;
	}
}
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void CubicGeneralisedLinearSpringForce<ELEMENT_DIM,
...
template class CubicGeneralisedLinearSpringForce<1, 1> ;
template class CubicGeneralisedLinearSpringForce<1, 2> ;
template class CubicGeneralisedLinearSpringForce<2, 2> ;
template class CubicGeneralisedLinearSpringForce<1, 3> ;
template class CubicGeneralisedLinearSpringForce<2, 3> ;
template class CubicGeneralisedLinearSpringForce<3, 3> ;
